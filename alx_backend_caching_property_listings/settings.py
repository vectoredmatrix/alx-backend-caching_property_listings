...
SECRET_KEY = 'django-insecure-7ekt7tv2pu7@o5sgjx)nca3r-fr6^7i5=i$0f7mj!hgy90h-q0'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'property_db'),
...
CACHES = {
    'default': {
        ...
        'LOCATION': f"redis://{os.getenv('CACHE_HOST', 'redis')}:6379/1",
        'OPTIONS': {
